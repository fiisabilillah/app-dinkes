        ...
        <nav class="navbar navbar-expand gap-3">
            ...
            <div class="user-box dropdown px-3">
                <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret"
                    ...
                    <img src="{{ !empty($profileData->photo) ? url('upload/super_images/' . $profileData->photo) : url('upload/no_image.jpg') }}"
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item d-flex align-items-center" href="{{ route('super.profile') }}"><i
                                class="bx bx-user fs-5"></i><span>Profile</span></a>
                    </li>
                    <li><a class="dropdown-item d-flex align-items-center"
                            href="{{ route('super.change.password') }}"><i class="bx bx-cog fs-5"></i><span>Change
                                Password </span></a> </li>
                    ...
                    <li><a class="dropdown-item d-flex align-items-center" href="{{ route('super.logout') }}"><i
