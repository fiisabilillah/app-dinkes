                    ...
                    <ul class="nav navbar-nav navbar-right" data-in="#" data-out="#">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Masonary
                                        Colum</a>
                                    <ul class="dropdown-menu">
                ...
                <div class="col-md-6 col-md-offset-3">
                    <form action="#" method="POST" id="login-form" class="white-popup-block"
                        ...
                        <div class="login-custom">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <label for="login-remember"><input type="checkbox" id="login-remember">Remember
                                        Me</label>
                                    <a title="Lost Password" href="#" class="lost-pass-link">Lost your
                                        password?</a>
                                </div>
                            </div>
                            <div class="col-md-12">
